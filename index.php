    ...
    <div class="footer-container">
      <div class="footer-row">
        <div class="footer-col" id="contact">
          <h4>Contact Us</h4>
          <p>HITECH CITY Hyderabad 12/4</p>
          <p>ramtulasibc@gmail.com</p>
          <p>Phone: +91 9154983687</p>
        </div>
      ...
      <div class="footer-bottom">
        <h4>&copy; 2024 Authored by Tulasiram,Vaibhav,Nikhil. All Rights Reserved.</h4>
      </div>
    </div>
  </footer>
